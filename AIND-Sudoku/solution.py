...
def naked_twins(values):
    ...
    #iterate all values. get ea dict item key
    #iterate through ea key
    for key in fnt:
    	for arr in units[key]:
    		for a in arr:
    			if (values[key] == values[a] and key != a):
    				#cycle through ea updated value
    				for y in arr:
    					if(y != key and y != a):
    ...
    #check ea value in list of columns
    #if twin found, append it to list
    #send twin back
